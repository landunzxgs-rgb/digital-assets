export default function FeaturedKnowledge() {
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-8 md:p-10">
        <div className="grid min-h-[280px] items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          {/* 左侧 */}
          <div>
            ...
            <div className="space-y-3">
              {articles.map((article) => (
                <a
                  key={article.title}
                  href={article.href}
                  className="group block border-b border-white/10 py-5 transition"
                >
